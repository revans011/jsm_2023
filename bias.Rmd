...
print("sample sizes from the papers: healey (216), innes (217), conz (334), baker (392)")
 parmlist<-list(
c(rep(1555,8)),             #interations; num.iter
c(161,91,191,151,55,126,143,241,100,125),  #cases; n.cases
c(55,126,143,241,161,91,191,151,100,125),  #controls unlabeled
c(rep(0.1,10)), #non-detection proportion
c(rep(0.5,10)) #treat effect
 )
