...
simRareSNP<-function(ORs, n0=500, n1=500, nSNP=0, rho=0,
                 ...
                 MAFslow=0.001, MAFsup=0.5, p0=0.05){  #MAFslow=0.001, MAFsup=0.01
...
foo<-simRareSNP(ORs=ORs
                ...
                , rho=0,
                 ...
                 MAFslow=MAFslow, MAFsup=MAFsup, p0=0.05)

labeled.rupture<-foo$Y
predisposition<-1*(foo$X>0) #the 1* converts logical to 0/1. 
...
sim.fun(200,5,60,5,150,50,0.05,.7,.9)
