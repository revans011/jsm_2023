...
foo<-data.frame(control=unlist(contrl)
           ...
           ,prop.agree.01=unlist(map2(contrl,case,\(contrl,case) sim.fun(num.iter=200
                                                                         ...
                                                                         ,case
                                                                         ,prop.nondetect=0.01)))
           ,prop.agree.05=unlist(map2(contrl,case,\(contrl,case) sim.fun(200,2,60,2,contrl,case,0.05)))
           ,prop.agree.1=unlist(map2(contrl,case,\(contrl,case) sim.fun(200,2,60,2,contrl,case,0.10)))
           ,prop.agree.25=unlist(map2(contrl,case,\(contrl,case) sim.fun(200,2,60,2,contrl,case,0.25)))
           ) |> 
