...
x.tru.control<-rnorm(n.dogs-n.tru.aff)
...
tru.dat<-data.frame(X=c(x.tru.affected,x.tru.control),
                       y=tru.labels)
...
# sim.table(parmlist=parmlist)
 ...
 print("sample sizes from the papers: healey (216)")
 parmlist<-list(
c(rep(10,3)),             #interations; num.iter
c(150,50,100),   #n.cases
c(50,150,100),   #number unlabeled
c(rep(.5,3)),
c(rep(0.3,3)) #non-detection proportion
