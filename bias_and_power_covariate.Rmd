...
return(pandoc.table(zoo1 %>% ungroup() %>% arrange(naive.p.mn)
...
###this checlks different patterns for the same sample size
 ...
 parmlist<-list(
c(rep(7555,6)),             #interations; num.iter
...
rep(c(161,150,108,121,100,95),2),  #cases; n.cases
rep(c(55,55,108,95,100,95),2),  #controls unlabeled
c(rep(0.5,12)), #treat effect
c(rep(0.001,6),rep(.1,6)) #non-detection proportion
 )
sim.table(parmlist=parmlist)
