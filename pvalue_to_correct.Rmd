...
#  parmlist<-list(
# c(rep(5000,3)),             #interations; num.iter
...
# ##This is to see if balance matters more than sample size
#  parmlist<-list(
...
return(pandoc.table(zoo1 %>% ungroup() %>% arrange(pu.less.tru)
