...
parmlist<-list(
c(rep(20,12)),             #interations; num.iter
c(100,80,80,100,80,80,100,80,80,100,80,80), #cases; n.cases
c(80,100,80,80,100,80,80,100,80,80,100,80), #controls PU; n.controls.unlabeled
c(rep(0.1,6),rep(0.05,6)),          #prop non detct ;prop.nondetect
c(0.38,0.38,0.38,0.1,0.1,0.1,0.38,0.38,0.38,0.1,0.1,0.1)  #treat effect; trt.eff 
 )
...
difftime(Sys.time(),now,units="mins")
```
